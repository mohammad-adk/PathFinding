...
public class DPAlgorithmTSP {
    ...
    private boolean evaluate(UndirectedGraph graph){
        ...
        if(N > 32){
            message = "Matrix too large! A matrix that size for the DP TSP problem with a time complexity of O(n^2*2^n) requires way too much computation for any modern home computer to handle";
            return false;
        }
